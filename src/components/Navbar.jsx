  ...
  return (
    <>
      <style>{`
        ...
        .nav-link { text-decoration: none; white-space: nowrap; transition: color 0.25s ease, border-color 0.25s ease; }
        .nav-link:hover { color: #e2e8f0 !important; }
        .mobile-link { display: block; text-decoration: none; padding: 12px 16px; border-radius: 8px; transition: background 0.2s; font-family: 'DM Sans', sans-serif; }
